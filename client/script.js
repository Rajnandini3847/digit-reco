...
function updateDebugCanvas() {
    ...
    // Scale up and draw to debug canvas with a larger size
    const scaleFactor = 5; // Adjust this for size of preview
    debugCtx.clearRect(0, 0, debugCanvas.width, debugCanvas.height); // Clear previous content
    debugCtx.drawImage(tempCanvas, 0, 0, 28 * scaleFactor, 28 * scaleFactor);
...
document.getElementById('predict-btn').addEventListener('click', async () => {
    try {
        ...
        // Add animation class to resultBox for pulse effect
        ...
        // Remove pulse animation after prediction is done
